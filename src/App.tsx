...
const AdminRecalibrateAnalytics = lazy(() => import("./pages/admin/AdminRecalibrateAnalytics"));
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: "recalibrate", element: <Suspense fallback={<LoadingFallback />}><AdminRecalibrateAnalytics /></Suspense> },
        ],
      },
    ],
  },
