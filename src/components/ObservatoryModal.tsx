  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-[101] animate-in slide-in-from-bottom duration-300">
        <div className="bg-background mx-4 mb-4 rounded-xl shadow-2xl max-w-2xl mx-auto overflow-hidden">
          ...
          <div className="px-4 pb-4 space-y-3">
            ...
            <div className="pt-1">
              <Button
                ...
                className="w-full bg-gradient-to-r from-amber-600 to-yellow-600 hover:from-amber-700 hover:to-yellow-700 text-white text-xs font-medium shadow-md h-9"
              >
                {ctaText}
              </Button>
            </div>
