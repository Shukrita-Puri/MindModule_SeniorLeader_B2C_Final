  ...
  const handleDownload = async () => {
    try {
      ...
      toast({
        ...
        description: "Your achievement badge has been saved as an image."
      });
      onShare?.();
    } catch (error) {
      toast({
        title: "Download failed",
        description: "Could not download badge image. Please try again.",
        variant: "destructive"
      });
    }
  };
    ...
    <div className="space-y-3">
      ...
      <div className="flex justify-center gap-3">
        ...
        <Button
          ...
          className="h-10 w-10 rounded-full"
          title={navigator.share ? "Share via..." : "Copy to clipboard"}
        >
