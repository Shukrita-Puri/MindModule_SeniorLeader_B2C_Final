      ...
      <div className="px-4 max-w-lg mx-auto">
        <div className="flex items-center gap-2">
          ...
          <MetricInfoModal
            ...
            description="Tailored preparation for the moments on your calendar that matter — surfaced when you need it, with practices to help you show up at your best."
          />
        </div>
