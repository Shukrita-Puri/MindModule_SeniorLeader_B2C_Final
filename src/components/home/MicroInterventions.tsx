...
const PerformancePreparationInterventions = () => {
      ...
      <div className="px-4 max-w-lg mx-auto">
        <div className="flex items-center gap-2">
          ...
          <MetricInfoModal
            ...
            description="Your preparation packs are intelligently generated by analyzing your calendar for upcoming high-stakes events (exams, interviews, presentations, competitions). We suggest practice 2-3 days before important events or same-day preparation when you need it most. Packs can include mindset reframes, somatic practices, and role-play exercises."
          />
        </div>
...
export default PerformancePreparationInterventions;
