/**
 * PillTooltip — Signal Pills v3 HoverCard.
 *
 * Lists raw contributors + bracketed qualifiers + a one-line "why this tier"
 * sentence for a single pill. Display-only. Tier reasoning is read off
 * the server-built `signalPills` payload echoed by compute-outer-readiness.
 */
...
export default function PillTooltip({
  pill,
  children,
}: {
