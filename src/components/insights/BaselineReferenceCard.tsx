...
const BaselineReferenceCard = ({ profile }: BaselineReferenceCardProps) => {
  ...
  return (
    <Card className="relative overflow-hidden bg-gradient-to-br from-card via-card to-card/95 border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.12)]">
      ...
      {/* Subtle saffron glow */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(242,106,80,0.05)_0%,transparent_50%)] pointer-events-none" />
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <InsightInfoModal
            ...
            explanation="Your starting point — the archetype and dimension scores from your onboarding assessment. Every other insight on this page is read against this."
          />
        </div>
      </CardHeader>
