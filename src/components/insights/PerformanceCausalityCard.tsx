...
// ── Burnout Risk tab ─────────────────────────────────────────────────
function BurnoutRiskTab({ matrix, isShareView = false }: { matrix: BurnoutMatrix; isShareView?: boolean }) {
    ...
    <div className="space-y-3">
      {view === 'day' ? (
        ...
        <div className="space-y-3">
          ...
          <DayTypeGrid dayTypes={monthlyTypes} days={days} cellFor={monthlyCell} isShareView={isShareView} />
          <RampLegend />
        </div>
      )}
