...
const UnifiedTopBar = ({ backPath, onBack, showBrand }: UnifiedTopBarProps) => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 safe-area-top bg-background/40 backdrop-blur-md">
      <div className="flex items-center justify-between px-4 py-2">
        {/* Left: Back Button */}
        <Button variant="ghost" size="icon" className="h-10 w-10 rounded-full" onClick={handleBack} aria-label="Back">
