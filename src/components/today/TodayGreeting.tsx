  ...
  return (
    ...
    >
      {editing ? (
        ...
        >
          <p className="font-headline font-semibold text-white tracking-tight leading-tight text-[26px] md:text-[42px] drop-shadow-[0_2px_6px_rgba(0,0,0,0.55)] [text-shadow:0_1px_2px_rgba(0,0,0,0.5)]">
            {greeting}
          </p>
          <Pencil className="w-3.5 h-3.5 md:w-4 md:h-4 text-white/80 drop-shadow-[0_1px_2px_rgba(0,0,0,0.5)] opacity-0 group-hover:opacity-90 group-active:opacity-100 transition-opacity" />
        </button>
      )}
    </div>
  );
