...
const SELF_MASTERY_PROGRESSION: ArchetypeInfo[] = [
  { id: 'self_mastery_initiate', name: 'Awareness Initiate', badgeColor: '#10B981', thresholdPoints: 25 },
  { id: 'self_mastery_practitioner', name: 'Emotional Navigator', badgeColor: '#059669', thresholdPoints: 50 },
  { id: 'self_mastery_adept', name: 'Regulation Adept', badgeColor: '#047857', thresholdPoints: 100 },
  { id: 'self_mastery_badge', name: 'Self Mastery Badge', badgeColor: '#065F46', thresholdPoints: 150 },
  { id: 'self_mastery_certificate', name: 'Self Mastery Certificate', badgeColor: '#064E3B', thresholdPoints: 250 },
];

const SOCIAL_MASTERY_PROGRESSION: ArchetypeInfo[] = [
  { id: 'social_mastery_initiate', name: 'Connection Initiate', badgeColor: '#6366F1', thresholdPoints: 25 },
  { id: 'social_mastery_practitioner', name: 'Empathy Practitioner', badgeColor: '#4F46E5', thresholdPoints: 50 },
  { id: 'social_mastery_adept', name: 'Influence Adept', badgeColor: '#4338CA', thresholdPoints: 100 },
  { id: 'social_mastery_badge', name: 'Social Mastery Badge', badgeColor: '#3730A3', thresholdPoints: 150 },
  { id: 'social_mastery_certificate', name: 'Social Mastery Certificate', badgeColor: '#312E81', thresholdPoints: 250 },
];
