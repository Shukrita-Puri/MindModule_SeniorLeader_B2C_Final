    ...
    <SidebarProvider defaultOpen={false}>
      <div className="min-h-screen flex w-full bg-background">
        ...
        <SidebarInset className="w-full overflow-x-hidden">
          ...
          {/* Sticky Tab Bar */}
          <div className="sticky top-0 z-30 bg-background/95 backdrop-blur-md <div className="sticky top-0 z-30 bg-background/95 backdrop-blur-md border-b border-white/[0.06]">">
