    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-4xl mx-auto px-4 pt-20 pb-12">
        ...
        <div className="space-y-8 text-foreground/80 font-body">
          ...
          <section>
            <h2 className="text-[17px] sm:text-xl font-body text-foreground mb-3">1. AI Services We Use</h2>
            <p className="mb-4">
          ...
          {/* 2. What AI Powers */}
          <section>
            <h2 className="text-[17px] sm:text-xl font-body text-foreground mb-3">2. Features Powered by AI</h2>
          ...
          <section>
            <h2 className="text-[17px] sm:text-xl font-body text-foreground mb-3">3. How AI Processing Works</h2>
            <p className="mb-4">
          ...
          {/* 4. Data Sent to AI */}
          <section>
            <h2 className="text-[17px] sm:text-xl font-body text-foreground mb-3">4. Data Sent to AI Services</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-[17px] sm:text-xl font-body text-foreground mb-3">5. AI Limitations and Disclaimers</h2>
          ...
          {/* 6. Human Oversight */}
          <section>
            <h2 className="text-[17px] sm:text-xl font-body text-foreground mb-3">6. Human Oversight</h2>
            <p className="mb-4">
          ...
          {/* 7. User Control */}
          <section>
            <h2 className="text-[17px] sm:text-xl font-body text-foreground mb-3">7. Your Control Over AI Features</h2>
          ...
          {/* 8. Data Security */}
          <section>
            <h2 className="text-[17px] sm:text-xl font-body text-foreground mb-3">8. Data Security</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-[17px] sm:text-xl font-body text-foreground mb-3">9. Third-Party AI Policies</h2>
            <p className="mb-4">
          ...
          {/* 10. Contact Us */}
          <section>
            <h2 className="text-[17px] sm:text-xl font-body text-foreground mb-3">10. Contact Us</h2>
            <p className="mb-4">
