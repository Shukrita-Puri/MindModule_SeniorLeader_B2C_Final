    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container max-w-4xl mx-auto px-4 pt-20 pb-12">
        ...
        <div className="space-y-8 text-foreground/80 font-body">
          ...
          <section>
            <h2 className="text-[17px] sm:text-[15px] sm:text-lg font-body text-foreground mb-3">1. Information We Collect</h2>
            
            <h3 className="text-[15px] sm:text-lg font-body text-foreground mb-2">1.1 Account and Authentication Data</h3>
            <p className="mb-4">
            ...
            <h3 className="text-[15px] sm:text-lg font-body text-foreground mb-2">1.2 Profile and Assessment Data</h3>
            <p className="mb-4">
            ...
            <h3 className="text-[15px] sm:text-lg font-body text-foreground mb-2">1.3 Usage and Interaction Data</h3>
            <p className="mb-4">
            ...
            <h3 className="text-[15px] sm:text-lg font-body text-foreground mb-2">1.4 AI Coaching Conversations</h3>
            <p className="mb-4">
            ...
            <h3 className="text-[15px] sm:text-lg font-body text-foreground mb-2">1.5 Calendar Integration (Optional)</h3>
            <p className="mb-4">
            ...
            <h3 className="text-[15px] sm:text-lg font-body text-foreground mb-2">1.6 Wearable Data (Optional, iOS Only)</h3>
            <p className="mb-4">
            ...
            <h3 className="text-[15px] sm:text-lg font-body text-foreground mb-2">1.7 Device and Technical Data</h3>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-[17px] sm:text-[15px] sm:text-lg font-body text-foreground mb-3">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-[17px] sm:text-[15px] sm:text-lg font-body text-foreground mb-3">3. AI-Powered Features</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-[17px] sm:text-[15px] sm:text-lg font-body text-foreground mb-3">4. Health and Medical Disclaimer</h2>
          ...
          {/* 5. Data Security */}
          <section>
            <h2 className="text-[17px] sm:text-[15px] sm:text-lg font-body text-foreground mb-3">5. Data Security</h2>
          ...
          <section>
            <h2 className="text-[17px] sm:text-[15px] sm:text-lg font-body text-foreground mb-3">6. Payment Processing</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-[17px] sm:text-[15px] sm:text-lg font-body text-foreground mb-3">7. Data Sharing and Disclosure</h2>
          ...
          <section>
            <h2 className="text-[17px] sm:text-[15px] sm:text-lg font-body text-foreground mb-3">8. International Data Transfers</h2>
            <p className="mb-4">
          ...
          {/* 9. Data Retention */}
          <section>
            <h2 className="text-[17px] sm:text-[15px] sm:text-lg font-body text-foreground mb-3">9. Data Retention</h2>
          ...
          {/* 10. Your Rights */}
          <section>
            <h2 className="text-[17px] sm:text-[15px] sm:text-lg font-body text-foreground mb-3">10. Your Rights</h2>
          ...
          <section>
            <h2 className="text-[17px] sm:text-[15px] sm:text-lg font-body text-foreground mb-3">11. Regional Privacy Rights</h2>
            
            <h3 className="text-[15px] sm:text-lg font-body text-foreground mb-2">11.1 European Union & United Kingdom (GDPR / UK GDPR)</h3>
            ...
            <h3 className="text-[15px] sm:text-lg font-body text-foreground mb-2">11.2 California, USA (CCPA / CPRA)</h3>
            ...
            <h3 className="text-[15px] sm:text-lg font-body text-foreground mb-2">11.3 Middle East & North Africa (MENA)</h3>
            <p className="mb-4">
            ...
            <h3 className="text-[15px] sm:text-lg font-body text-foreground mb-2">11.4 Asia-Pacific (APAC)</h3>
            <p className="mb-4">
            ...
            <h3 className="text-[15px] sm:text-lg font-body text-foreground mb-2">11.5 Apple App Store Compliance</h3>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-[17px] sm:text-[15px] sm:text-lg font-body text-foreground mb-3">12. Cookies and Tracking</h2>
          ...
          {/* 13. Age Restriction */}
          <section>
            <h2 className="text-[17px] sm:text-[15px] sm:text-lg font-body text-foreground mb-3">13. Age Restriction</h2>
            <p>
          ...
          <section>
            <h2 className="text-[17px] sm:text-[15px] sm:text-lg font-body text-foreground mb-3">14. Changes to This Policy</h2>
            <p>
          ...
          {/* 15. Contact Us */}
          <section>
            <h2 className="text-[17px] sm:text-[15px] sm:text-lg font-body text-foreground mb-3">15. Contact Us</h2>
