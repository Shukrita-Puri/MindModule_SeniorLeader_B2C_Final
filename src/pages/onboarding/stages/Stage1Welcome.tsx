  ...
  return (
    <div className="space-y-8 py-12 animate-fade-in">
      ...
      <div className="text-center space-y-2 animate-fade-in delay-100">
        <h1 className="text-[28px] sm:text-4xl font-headline text-foreground tracking-tight uppercase">
          Mind Module
        </h1>
        <p className="text-[10px] tracking-[0.25em] uppercase text-muted-foreground font-headline">
          Executive Edition
        </p>
      </div>
