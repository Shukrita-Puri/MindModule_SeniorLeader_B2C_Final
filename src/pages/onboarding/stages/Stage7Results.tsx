...
export default function Stage7Results() {
  ...
  if (loading) {
    return <div className="space-y-8 py-12 text-center animate-fade-in">
  ...
  return <div className="space-y-6 py-8 animate-fade-in">
      ...
      <div className="text-center space-y-4">
        ...
        <div className="max-w-md mx-auto space-y-3">
          <div className="relative">
            ...
            <div className="absolute top-0 bottom-0 w-0.5 bg-muted-foreground/50" style={{
            left: `${nationalAvg}%`
          }} />
          </div>
      ...
      <div className="bg-card border border-border rounded-xl p-6">
        ...
        <div className="space-y-3">
          {insights.patternRevealation.map((pattern: string, index: number) => <div key={index} className="pb-3 border-b border-border last:border-0 last:pb-0">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-background/50 rounded-lg p-4 space-y-3">
            ...
            <ul className="text-sm space-y-1.5 text-muted-foreground">
              {insights.expectedOutcomes.map((outcome: string, index: number) => <li key={index}>• {outcome}</li>)}
            </ul>
          </div>
      ...
      {/* CTA */}
      <Button size="lg" onClick={() => navigate("/onboarding/context-connection")} className="w-full group">
