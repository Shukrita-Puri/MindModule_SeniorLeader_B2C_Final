  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="relative pt-20 pb-6 px-6 max-w-4xl mx-auto">
        ...
        <p className="text-muted-foreground text-sm font-body context-clamp">Reset and restore composure, regain clarity, and maintain executive poise, in moments of intensity.</p>
      </div>
