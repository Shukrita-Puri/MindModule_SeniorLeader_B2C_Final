  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div 
        ...
        style={{ backgroundImage: `url('/lovable-uploads/aa4d150b-e5fe-48d7-aa74-9f082d21ffaa.png')` }}
      >
        ...
        <div className="relative h-full flex flex-col justify-center px-6 max-w-4xl mx-auto">
          ...
          <p className="text-cream/80 text-lg">Breathing exercises and calming sounds for stress relief, restoration, and grounding</p>
        </div>
      </div>
