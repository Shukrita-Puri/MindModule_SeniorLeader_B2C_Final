...
export type MomentType = 
  | 'pre-performance'   // High-stakes academic/performance event
  | 'pre-social'        // Social/networking events
...
export interface MomentCandidate {
  ...
  label: string;                 // UI label like "In 45 min", "Between classes"
...
function isHighStakesEvent(eventType: StudentEventType): boolean {
 ...
 * Returns max 2 best moments for the day, sorted by priority
 */
...
// Get appropriate pack template based on event type
