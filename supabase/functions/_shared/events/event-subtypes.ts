...
const ROWS: RawSubtype[] = [
  ...
  // v2 additive — school/nonprofit governance role. Insert BEFORE gov.board_meeting so
  // "school board", "trustee meeting" and "governor role" route here, not to corporate board.
  { id:'gov.trustee',          label:'Trustee / School board / Nonprofit board', bucket:'High-Stakes Governance', categoryId:'A', group:'A_governance', primaryPillar:3, secondaryPillar:1, demandProfile:D(2,2,1,2,3,1,0,1), timingMatrix:{pre:true,during:false,post:true}, regulationObjective:'PREPARE', interventionType:'Flow', keywords:['governor role','trustee','school board','nonprofit board','charity board','school governor'], masteryModules:['regulate','align','prepare'], jitLeadTimeMinutes:720 },
  ...
  { id:'inf.pitch_competitive',label:'Competitive pitch / RFP',bucket:'Influence & Persuasion', categoryId:'B', group:'B_investor', primaryPillar:2, secondaryPillar:1, demandProfile:D(2,2,3,2,1,3,0,3), timingMatrix:{pre:true,during:false,post:true}, regulationObjective:'PREPARE', interventionType:'Reenergise', keywords:['pitch to ','competitive pitch','bake-off','bake off','rfp presentation','rfp pitch'], masteryModules:['regulate','align','prepare'], jitLeadTimeMinutes:720 },
  ...
  { id:'vis.stakeholder_comm', label:'Stakeholder communication', bucket:'Visibility & Communication', categoryId:'C', group:'D_visibility', primaryPillar:2, secondaryPillar:1, demandProfile:D(2,1,3,2,2,2,0,2), timingMatrix:{pre:true,during:false,post:true}, regulationObjective:'PREPARE', interventionType:'Reenergise', keywords:['results to leadership','update to leadership','exec update','leadership update','results presentation','q1 presentation to','q2 presentation to','q3 presentation to','q4 presentation to'], masteryModules:['regulate','align','prepare'], jitLeadTimeMinutes:360 },
  ...
  { id:'lead.difficult_conversation', label:'Difficult conversation / Escalation', bucket:'People & Difficult Conversations', categoryId:'D', group:'E_leadership', primaryPillar:3, demandProfile:D(1,3,1,2,3,2,0,1), timingMatrix:{pre:true,during:false,post:true,postMandatory:true}, regulationObjective:'PREPARE', interventionType:'Pause', keywords:['difficult','feedback','pip','conflict','dispute','tension','confrontation','escalation'], excludeKeywords:['pipeline','pipe ','pipework','feedback loop','feedback form','beta feedback','beta test feedback','feedback session','feedback review','user feedback','customer feedback','product feedback','feedback analysis'], masteryModules:['regulate','prepare'], jitLeadTimeMinutes:240 },
  ...
  { id:'lead.hiring_interview',label:'Hiring interview (candidate)', bucket:'People & Difficult Conversations', categoryId:'D', group:'E_leadership', primaryPillar:3, secondaryPillar:1, demandProfile:D(2,1,1,1,2,1,0,1), timingMatrix:{pre:true,during:false,post:false}, regulationObjective:'PREPARE', interventionType:'Pause', keywords:['screening interview','screening call','candidate screen','phone screen','interview with '], masteryModules:['align','prepare'], jitLeadTimeMinutes:240 },
  { id:'lead.hiring_committee',label:'Job interview / Hiring committee', bucket:'People & Difficult Conversations', categoryId:'D', group:'E_leadership', primaryPillar:3, secondaryPillar:1, demandProfile:D(2,1,1,1,2,1,0,1), timingMatrix:{pre:true,during:false,post:false}, regulationObjective:'PREPARE', interventionType:'Pause', keywords:['job interview','final round interview','final round','hiring committee','offer discussion','executive hire','candidate','interview'], masteryModules:['align','prepare'], jitLeadTimeMinutes:240 },
  ...
  { id:'str.learning',         label:'Learning / Passive attendee', bucket:'Deep Work & Strategy', categoryId:'E', group:'C_strategic', primaryPillar:1, demandProfile:D(1,0,0,0,1,1,0,0), timingMatrix:{pre:false,during:false,post:false}, regulationObjective:'PROTECT', interventionType:'Flow', keywords:['webinar','masterclass','fireside chat','online course','online class','learn to','psychology of','what really','what it takes'], excludeKeywords:['hosting webinar','running webinar','delivering masterclass'], classificationOnly:true },
  { id:'str.community',        label:'Community / Member group', bucket:'Deep Work & Strategy', categoryId:'E', group:'C_strategic', primaryPillar:3, demandProfile:D(1,1,1,0,3,1,0,1), timingMatrix:{pre:false,during:false,post:false}, regulationObjective:'PROTECT', interventionType:'Pause', keywords:['breakfast club','thursday connects','chapter meeting','network group','community forum','member group','members meeting','roundtable'], classificationOnly:true },
  { id:'str.review',           label:'Review (BP / product / design / sprint)', bucket:'Deep Work & Strategy', categoryId:'E', group:'C_strategic', primaryPillar:1, secondaryPillar:4, demandProfile:D(2,1,1,1,2,1,0,1), timingMatrix:{pre:true,during:false,post:false}, regulationObjective:'PREPARE', interventionType:'Flow', keywords:['bp review','product review','design review','sprint review','retro','retrospective'], excludeKeywords:['board','investor','budget review','performance review','annual review','mid-year review'], masteryModules:['prepare'], jitLeadTimeMinutes:240 },
  { id:'str.compliance',       label:'Compliance / Legal / Filing', bucket:'Deep Work & Strategy', categoryId:'E', group:'C_strategic', primaryPillar:1, demandProfile:D(2,0,0,1,1,1,0,1), timingMatrix:{pre:true,during:false,post:false}, regulationObjective:'PREPARE', interventionType:'Flow', keywords:['uk filing','visa appointment','compliance review','legal review','audit review','tax filing','regulatory filing'], excludeKeywords:['audit committee'], masteryModules:['prepare'], jitLeadTimeMinutes:240 },
  ...
  { id:'str.deep_work',        label:'Deep work block',       bucket:'Deep Work & Strategy', categoryId:'E', group:'C_strategic', primaryPillar:1, demandProfile:D(3,0,0,0,0,1,0,0), timingMatrix:{pre:false,during:true,post:false}, regulationObjective:'PROTECT', interventionType:'Flow', keywords:['deep work','focus block','writing time','beta test feedback','beta feedback','feedback review','feedback analysis','feedback session','user feedback','customer feedback','product feedback'] },
  ...
  { id:'trv.flight',           label:'Flight / Travel',       bucket:'Travel', categoryId:'G', group:'G_travel', primaryPillar:4, secondaryPillar:5, demandProfile:D(1,1,0,0,0,2,2,0), timingMatrix:{pre:true,during:true,post:true}, regulationObjective:'PROTECT', interventionType:'Pause', keywords:['flight','airport','boarding','departure','arrival','layover','in transit'], excludeKeywords:['onboarding','off-boarding','offboarding','flight showcase','flight deck review','flight risk','test flight','transition'] },
  ...
  { id:'rhy.holiday',          label:'Public / bank holiday', bucket:'Daily Rhythm & Baseline', categoryId:'H', group:'H_recovery', primaryPillar:5, demandProfile:D(0,0,0,0,0,0,0,1), timingMatrix:{pre:false,during:false,post:false}, regulationObjective:'RECOVER', interventionType:'Pause', keywords:['bank holiday','public holiday','national holiday','federal holiday'], classificationOnly:true },
  { id:'rhy.wellness_fitness', label:'Wellness — fitness',    bucket:'Daily Rhythm & Baseline', categoryId:'H', group:'H_recovery', primaryPillar:5, demandProfile:D(0,0,0,0,0,1,0,0), timingMatrix:{pre:false,during:false,post:false}, regulationObjective:'RECOVER', interventionType:'Pause', keywords:['gym','workout','yoga class','pilates','spin class','swim session','running club','cycling class'], classificationOnly:true },
  { id:'rhy.wellness_self_care', label:'Wellness — self care', bucket:'Daily Rhythm & Baseline', categoryId:'H', group:'H_recovery', primaryPillar:5, demandProfile:D(0,0,0,0,0,0,0,1), timingMatrix:{pre:false,during:false,post:false}, regulationObjective:'RECOVER', interventionType:'Pause', keywords:['massage','spa appointment','manicure','pedicure','facial appointment','salon appointment'], classificationOnly:true },
  { id:'rhy.wellness_health_check', label:'Wellness — health check', bucket:'Daily Rhythm & Baseline', categoryId:'H', group:'H_recovery', primaryPillar:5, demandProfile:D(0,1,0,0,0,0,0,1), timingMatrix:{pre:false,during:false,post:false}, regulationObjective:'PROTECT', interventionType:'Pause', keywords:['weigh day','weigh-in','blood test','health check','physical exam','annual physical','medical check'], classificationOnly:true },
  { id:'rhy.wellness_medical', label:'Wellness — medical appointment', bucket:'Daily Rhythm & Baseline', categoryId:'H', group:'H_recovery', primaryPillar:5, demandProfile:D(0,1,0,0,0,0,0,1), timingMatrix:{pre:false,during:false,post:false}, regulationObjective:'PROTECT', interventionType:'Pause', keywords:['doctor appointment','dentist appointment','physio','physiotherapy','osteopath','chiropractor','gp appointment'], classificationOnly:true },
  { id:'rhy.social',           label:'Personal social',       bucket:'Daily Rhythm & Baseline', categoryId:'H', group:'H_recovery', primaryPillar:5, demandProfile:D(0,0,0,0,1,0,0,0), timingMatrix:{pre:false,during:false,post:false}, regulationObjective:'PROTECT', interventionType:'Pause', keywords:['coffee with','drinks with','dinner with','beer with','brunch with','walk with'], classificationOnly:true },
  { id:'rhy.family',           label:'Family / Personal',     bucket:'Daily Rhythm & Baseline', categoryId:'H', group:'H_recovery', primaryPillar:5, demandProfile:D(0,1,0,0,2,0,0,1), timingMatrix:{pre:false,during:false,post:false}, regulationObjective:'PROTECT', interventionType:'Pause', keywords:['birthday','anniversary','family dinner','school play','school pickup','school fair','kids party','wedding'], classificationOnly:true },
  { id:'rhy.recreation',       label:'Recreation / Culture',  bucket:'Daily Rhythm & Baseline', categoryId:'H', group:'H_recovery', primaryPillar:5, demandProfile:D(0,0,0,0,0,0,0,0), timingMatrix:{pre:false,during:false,post:false}, regulationObjective:'RECOVER', interventionType:'Pause', keywords:['concert','matinee','opera','ballet','theatre show','theater show','festival','stars on ice'], classificationOnly:true },
