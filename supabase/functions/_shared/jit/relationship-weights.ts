...
} from "./relationship-taxonomy.ts";

export type ResolvedRole = RelationshipRole | "boss" | "report";

const TAXONOMY_WEIGHTS = Object.fromEntries(
  Object.entries(RELATIONSHIP_TAXONOMY).map(([k, v]) => [k, v.weight]),
) as Record<RelationshipRole, number>;
