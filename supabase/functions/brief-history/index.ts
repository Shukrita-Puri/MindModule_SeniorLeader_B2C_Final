...
serve(async (req) => {
  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .select('id, local_date, time_window, daily_checkin_id, phrase, body_text, lean_on, lean_on_source, watch_for, watch_for_source, brief_source, driver, score, tier, user_rating, feedback_text, created_at')
      .eq('user_id', userId)
