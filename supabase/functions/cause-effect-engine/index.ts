    ...
    const dayTypeHrvMatrix: DayTypeHrvMatrix | null = (() => {
      ...
      if (worstType && worstType.meanDelta < 0 && worstN >= 3) {
        ...
        const copy: Record<string, string> = {
          ...
          "Travel": "Travel days take the longest toll — your body consistently recovers less the morning after these.",
          "Board & Governance": "Your body recovers least after Board & Governance days — the physical toll carries into the next morning.",
          "Interpersonal High-Stakes": "High-stakes interpersonal days leave a mark — your body's recovery the next morning is consistently lower after these.",
          "Visibility & Comms": "Visibility days take more out of you than they may feel — your body recovers less the morning after these.",
          "Business Development": "Pitching days carry a real physical cost — your body recovers least the morning after these.",
          "Conferences & Events": "Conference days take a sustained toll — the physical cost carries into the next morning.",
          "Deep Work & Strategy": "Even focused work days leave a trace — your body recovers less the morning after these.",
          "Learning & Development": "Learning-heavy days cost more than they appear to — your body recovers less the morning after these.",
