...
// correctly. Downstream label code (composeStateLabel, resolveJitPhaseLabel)
// relies on these guarantees.

import { assert, assertEquals } from "https://deno.land/std@0.224.0/assert/mod.ts";
import { enrichEvent } from "./index.ts";
