...
BEGIN
  ...
  -- Restrict to base tables only. Views (e.g. web_primary_calendar_events)
  -- also expose a user_id column but cannot accept DELETE, which was
  -- causing the RPC to abort.
  FOR r IN
    SELECT c.table_name
    ...
    WHERE c.table_schema = 'public'
      ...
      AND c.table_name <> 'referral_conversions'
